    ...
    <>
      ...
      <nav className={`navbar${isScrolled ? ' scrolled' : ''}`}>
        <div className="container nav-container">
          ...
          <div className="nav-links">
            ...
            <a href="/downloads/neurofi-android.apk" download="neurofi-android.apk" className="btn btn-nav-download">
      ...
      <div className={`mobile-menu${isMobileMenuOpen ? ' active' : ''}`}>
        <div className="mobile-nav-links">
          ...
          <a href="/downloads/neurofi-android.apk" download="neurofi-android.apk" className="mobile-link" onClick={closeMobileMenu}>⬇ Download App</a>
